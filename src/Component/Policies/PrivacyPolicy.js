...
const PrivacyPolicy = () => {
  return (
    <div>
      <Helmet>
        <title>
        Privacy Policy | Groavy Buildcon: Your Data, Our Priority
        </title>
        <meta
          name="description"
          content="Groavy's Privacy Policy details our practices for data protection. We prioritize your privacy and explain how we safeguard your personal information."
        />
        <meta
          name="keywords"
          content="Groavy Buildcon, privacy policy, data handling, personal information"
        />
        <meta name="author" content="Groavy Buildcon" />
        <meta property="og:image" content="URL-to-your-featured-image" />

        <meta property="og:title" content=" Privacy Policy | Groavy Buildcon: Your Data, Our Priority" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.groavy.com/privacypolicies"
        />
        <meta property="og:site_name" content="Groavy Buildcon" />
        <meta name="twitter:title" content=" Privacy Policy | Groavy Buildcon: Your Data, Our Priority" />
        <meta
        ...
        <link rel="canonical" href="https://www.groavy.com/privacypolicies" />
      </Helmet>

      <section class="section service" id="service" aria-label="service">
        <div class="container text-secondary mt-4">
          <h1 class="h2 section-title">Groavy Buildcon:Privacy Policy</h1>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Groavy Buildcon.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Groavy Buildcon, accessible
                forms
                {/* <a href="https://groavy.com/"
              rel="external nofollow noopener" target="_blank">https://groavy.com/</a> */}
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>By email: support@groavy.com</li>
          </ul>
        </div>
      </section>
    </div>
